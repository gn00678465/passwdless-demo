...
export function decodeAttestationObject(attestationObject: string) {
  return isoCBOR.decodeFirst<AttestationObject>(
    new Uint8Array(Base64Url.decodeBase64Url(attestationObject))
  );
}
